package ru.opencart.idea.marker
...
import ru.opencart.idea.event.OcEventSubscriberIndex
...
class OcEventLineMarkerProvider : RelatedItemLineMarkerProvider() {
    ...
    private fun kindOf(root: ru.opencart.idea.core.OcRoot, file: com.intellij.openapi.vfs.VirtualFile): OcRouteKind? {
